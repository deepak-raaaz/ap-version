    ...
    <div className="bg-white">
      <div className="max-w-screen-xl mx-auto max-xl:mx-4 py-10 grid grid-cols-2 gap-16 max-lg:gap-4 max-900px:grid-cols-1 ">
        <div className="max-900px:order-2 max-900px:mt-6">
          ...
          <h3 className="text-2xl font-bold mt-5 mb-2 text-slate-900">
          ...
          <h4 className="text-lg font-medium mt-3">Key Features:</h4>
          ...
          <div className="flex gap-2">
            <Button variant="outline" size="icon" className="border-slate-400">
              <FaPhone className="h-4 w-4 text-slate-400" />
            </Button>
            <Button variant="outline" size="icon" className="border-slate-400">
              <IoLogoWhatsapp className="h-4 w-4 text-slate-500" />
            </Button>
            <Button variant="outline" className="border-slate-400 py-0">
              View Details
            </Button>
          </div>
        </div>
