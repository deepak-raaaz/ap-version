  ...
  return (
    <div className="mt-10">
      <div className="max-w-screenxl mx-auto max-xl:mx-4  bg-secondary-banner-image h-[35rem] max-sm:h-[28rem] bg-no-repeat bg-center relative">
        ...
        <img src={Icon1} alt="" className="ms-20 w-32  max-sm:w-24"/>
        <img src={Icon2} alt="" className=" w-32 max-sm:w-24"/>
        <img src={Icon3} alt="" className=" w-32 max-sm:w-24"/>
        <img src={Icon4} alt="" className="ms-20 w-32 max-sm:w-24"/>
        </div>
        <img src={PacketImg} alt="" className="absolute right-[7%] max-sm:top-[25%] top-[22%] w-96 max-xl:right-0 max-lg:w-[22rem] max-sm:w-[15rem]" />
      </div>
